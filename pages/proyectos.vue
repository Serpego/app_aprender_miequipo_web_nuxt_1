...
export default {
    ...
    methods: {
      itemsTraidosDeBlogger (ctx) { //U: trae los items de blogger y los formatea para b-table
        let promise = this.$axios.get('https://cors-anywhere.herokuapp.com/https://pizarra.podemosaprender.org/feeds/posts/default/-/Proyecto/?alt=json') //A: de blogger como json
