...
<p>Fecha efectiva: December 16, 2018</p>


<p>MiEquipo en PodemosAprender ("nosotros", "a nosotros", "nuestro") opera el sitio web miequipo.podemosaprender.org (en adelante, el "Servicio").</p>
...
<p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el miequipo.podemosaprender.org</p>

<h2>Definiciones</h2>
<ul>
    <li>
        <p><strong>Servicio</strong></p>
                <p>Servicio es el sitio web miequipo.podemosaprender.org operado por MiEquipo en PodemosAprender</p>
            </li>
    <li>
...
<h2>Uso de datos</h2> 
<p>MiEquipo en PodemosAprender utiliza los datos recopilados con diversas finalidades:</p>    
<ul>
...
<p>MiEquipo en PodemosAprender puede divulgar sus Datos personales de buena fe cuando considere que esta acción es necesaria para lo siguiente:</p>
<ul>
    <li>Cumplir una obligación legal</li>
    <li>Proteger y defender los derechos o bienes de MiEquipo en PodemosAprender</li>
...
<ul>
        <li>Por e-mail: ayuda@podemosaprender.org</li>
